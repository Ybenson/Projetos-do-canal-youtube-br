'''
  Calculadora Python simples baseado livremente no Texas Instruments DataMath II
  produzido por volta de 1975
  
  Author:     Ybenson Augustave
  Email :     ybenson.augustave@yahoo.com
  Date  :     10/06/2020
...
##-----WINDOW AND LAYOUT---------------------------------##
layout: list = [
    [sg.Text('FATEC-OSASCO', size=(50,1), justification='right', background_color="#272533", 
...
window: object = sg.Window('Ybenson Augustave', layout=layout, background_color="#272533", size=(580, 660), return_keyboard_events=True)
